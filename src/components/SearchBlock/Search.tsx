...
const Search = () => {
  ...
  return (
    <div className={styles.root}>
      <svg className={styles.icon} version="1.1" id="Layer_1" x="0px" y="0px" width="122.879px" height="119.799px"
           viewBox="0 0 122.879 119.799" enableBackground="new 0 0 122.879 119.799">
        <g>
          <path
      ...
      {
        setSearchValue('') &&
        <svg className={styles.clearIcon} onClick={() => onClickClear()} xmlns="http://www.w3.org/2000/svg"
